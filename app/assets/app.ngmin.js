...
!angular.$$csp() && angular.element(document).find('head').prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\\:form{display:block;}.ng-animate-start{clip:rect(0,auto,auto,0);-ms-zoom:1.0001;}.ng-animate-active{clip:rect(-1px,auto,auto,0);-ms-zoom:1;}</style>');(function (window, angular, undefined) {
  'use strict';
...
}(window, window.angular));if (typeof module !== 'undefined' && typeof exports !== 'undefined' && module.exports === exports) {
...
}(window, window.angular));angular.module('Scope.safeApply', []).run([
  '$rootScope',
  function ($rootScope) {
...
]);angular.module('configuration', []).provider('config', function () {
  var appVersion = 8;
  var templatePath = [
      'scripts',
      'modules'
...
;var app = angular.module('app', [
    ...
    'configProvider',
    '$locationProvider',
    function ($stateProvider, configProvider, $locationProvider) {
      var template = configProvider.template('app'), root = {
          abstract: true,
          views: {
            '@': { template: template.abstract },
            navigation: { templateUrl: template('navigation') }
          }
        };
      if (window.location.pathname !== '/') {
        root.url = window.location.pathname.substr(0, window.location.pathname.lastIndexOf('/'));
      }
      $stateProvider.state('app', root).state('app.home', {
        url: '/index.html',
...
;var module = angular.module('application', [
    ...
    '$urlRouterProvider',
    'configProvider',
    function ($locationProvider, $urlRouterProvider, configProvider) {
